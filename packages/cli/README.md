...
You can test your Query Lambda SQL during development through several channels.
...
to deploy a new data query (or rollback to a previous data query) without having to deploy your application code at all.
