...
`;
  ...
  static usage = 'api:queryLambdas:createQueryLambdaTag -f request.yaml';
  ...
  async run() {
    ...
    // Arguments for API call. These arguments are the same as CreateQueryLambdaTag.args for a GET request
    const namedArgs: Args = [
      ...
      },
      {
        name: 'body',
        description:
          'JSON Body for this POST request. Full schema at https://docs.rockset.com/rest-api#createquerylambdatag ',
        required: true,
        hidden: false,
      },
    ];
