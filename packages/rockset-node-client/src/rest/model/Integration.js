(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AwsExternalIdIntegration', 'model/AwsKeyIntegration', 'model/DynamodbIntegration', 'model/GcpServiceAccount', 'model/GcsIntegration', 'model/KinesisIntegration', 'model/RedshiftIntegration', 'model/S3Integration'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AwsExternalIdIntegration'), require('./AwsKeyIntegration'), require('./DynamodbIntegration'), require('./GcpServiceAccount'), require('./GcsIntegration'), require('./KinesisIntegration'), require('./RedshiftIntegration'), require('./S3Integration'));
  } else {
    // Browser globals (root is window)
    if (!root.RestApi) {
      root.RestApi = {};
    }
    root.RestApi.Integration = factory(root.RestApi.ApiClient, root.RestApi.AwsExternalIdIntegration, root.RestApi.AwsKeyIntegration, root.RestApi.DynamodbIntegration, root.RestApi.GcpServiceAccount, root.RestApi.GcsIntegration, root.RestApi.KinesisIntegration, root.RestApi.RedshiftIntegration, root.RestApi.S3Integration);
  }
}(this, function(ApiClient, AwsExternalIdIntegration, AwsKeyIntegration, DynamodbIntegration, GcpServiceAccount, GcsIntegration, KinesisIntegration, RedshiftIntegration, S3Integration) {
    'use strict';
