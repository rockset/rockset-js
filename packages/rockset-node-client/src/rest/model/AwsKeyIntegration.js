(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RestApi.AwsKeyIntegration = factory(root.RestApi.ApiClient);
  }
  ...
  /**
   * The AwsKeyIntegration model module.
   * @module model/AwsKeyIntegration
   * @version v1
   */

  /**
   * Constructs a new <code>AwsKeyIntegration</code>.
   * @alias module:model/AwsKeyIntegration
   * @class
  ...
  /**
   * Constructs a <code>AwsKeyIntegration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AwsKeyIntegration} obj Optional instance to populate.
   * @return {module:model/AwsKeyIntegration} The populated <code>AwsKeyIntegration</code> instance.
   */
